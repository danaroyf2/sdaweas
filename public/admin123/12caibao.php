...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 团课预约详情 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="mt-20">
        ...
        $sql1="select  * from mytuanke where tid=$id";		
        //echo $sql;		
                        ...
                        while($row=mysqli_fetch_assoc($rs))
                        {
                            ...
                            <tr class="text-c">
                                ...
                                <td><?php echo $row["jifen"]?></td>
                                 <td> <td ><a href="12fanshui.php?id=<?php echo $row["id"]?>"><div id="yangshi">查看订单</div></a></td></td>
                                <td><?php
                                if($row["jiaolian"]==1)
                                {
                                ?>

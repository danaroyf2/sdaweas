...
<!--	<a class="btn btn-primary radius" data-title="导出excel" data-href="article-add.html" onclick="daochu()" href="javascript:;">导出excel</a>-->
	<div class="mt-20">
        ...
        $sql="select  * from tixian  order by Id desc";		
        //echo $sql;		
    ...
    echo $rowbuy["name"];
                ?>
                 ...
                 <?php
                  if($row['plate']==1){
                      ?>
                       <td class="text-l">
                      开户姓名：<?php echo  $row["bank_name"]?><br>
                      银行卡号：<?php echo  $row["bank_card"]?><br>
                      银行开户行：<?php echo  $row["bank_add"]?><br>
                      </td>
                      <?php
                  }
                  if($row['plate']==2){
                      ?>
                      <td>
                      <a onclick="article_edit('查看打款码','erwei.php?name=<?php echo  $row["bank_name"]?>&img=<?php echo  $row["bank_card"]?>',<?php echo  $row["id"]?>,'500px','300px')" href="javascript:;" ><div class="btn btn-success">查看打款码</div></a>
                       </td>
                      <?php
                  }
                  ?>
                ...
                <td >
                    <?php
                                ...
                                {
                                ?>
                                <a style="text-decoration:none; color: #FFFFFF ;" onClick="dltype1(this,<?php echo $row["id"]?>)" href="javascript:;" title="同意"> <div class="btn btn-success">同意提现</div></a> 
                  ...
                  <td >
                    <?php
                                ...
                                {
                                ?>
                 <a style="text-decoration:none; color: #FFFFFF ;" onClick="dltype2(this,<?php echo $row["id"]?>)" href="javascript:;" title="驳回"> <div class="btn btn-success">驳回</div></a> 
...
function dltype2(obj,id){
	layer.confirm('确定驳回该提现申请吗？',function(index){

...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 团课列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <tr class="text-c">
               ...
               <td ><?php echo $row["id"]?></td>
                ...
                <td >echo</td>
                  ...
                  <td > <a href="ceshi.php?id=<?php echo $row["id"]?>">查看内容</a>  </td>
                <td ><?php echo $row["money"]?></td>
                
                  <td ><?php echo $row["shijian"]?></td>
                <td ><?php echo $row["scliang"]?></td>

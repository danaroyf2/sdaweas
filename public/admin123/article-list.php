...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 转账列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<div class="mt-20">
        ...
        while($row=mysqli_fetch_assoc($rs))
        {
            ...
            <tr class="text-c">
                ...
                <td ><?php echo $row["out_biz_no"]?></td>
                <td><?php echo $row["name"]?></td>
                <td><?php echo $row["payee_account"]?></td>

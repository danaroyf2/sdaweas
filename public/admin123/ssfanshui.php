...
<body>
        ...
        if($_POST['add_xinxi'])
        {
          ...
          $cal=$_POST['cal'];//团课名称
            ...
            $in_sql="insert into tuantype (name,enname,miaoshu,imgs,cal) values ('$name','$enname','$xiangqing','$imgs',$cal)";
...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-member-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>团课图片：</label>
			<div class="formControls col-xs-8 col-sm-9">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="cal" name="cal" style="width:300px;">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
			    <script id="editor" type="text/plain" name='xiangqing'></script>

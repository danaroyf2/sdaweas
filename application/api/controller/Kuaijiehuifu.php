...
class Kuaijiehuifu extends CRUD{
    
    
    public $table='wolive_reply';
    ...
    public function add(){
        ...
        $data['word']=htmlspecialchars_decode($data['word'],ENT_QUOTES); 
        $data['service_id']=$this->serverUser['service_id'];
        $lastid=$this->DbModel->where(['service_id'=>$this->serverUser['service_id']])->order('weigh desc')->value('id');

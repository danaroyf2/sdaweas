...
<body>
        ...
        if($_POST['add_xinxi'])
        {
            ...
            $xiangqing=$_POST['xiangqing'];//详情
           	...
           	$u_up_sql="update tuantype set name='$name',enname='$enname',imgs='$imgs',cal='$cal',miaoshu='$xiangqing' where id=$id";
            ...
            ?>
                        <?php
            $id=$_GET["id"];
        $sqlcha=" select * from tuantype where id=$id";	
...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>英文名字：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>团课图片（修改需要重新上传图片）：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" placeholder="" id="imgs" name="imgs" style="width:300px;" >
			</div>
		</div>
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>cal：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $rowcha["cal"];?>" placeholder="" id="cal" name="cal" style="width:300px;">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
			    <script id="editor" type="text/plain" name='xiangqing'><?php echo $rowcha["miaoshu"];?></script>

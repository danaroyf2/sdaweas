        ...
        $("#picture").ajaxSubmit({
            ...
            success: function (res) {
                if(res.code == 0){
                    ...
                    str += "<div class='outer-right'><div class='customer' style='padding:0;border-radius:0;max-height:auto'>";
                    str += "<pre>" + msg + "</pre>";
                    str += "</div></div>";
                    str += "</li>";
...
function getdata(){
    ...
    var cmin =curentdata.getMinutes();
        ...
        $.ajax({
            ...
            type: "post",
            data: {hid:cid,vid:visiter_id,business_id:business_id,service_id:se,token:localStorage.getItem('token')},
            dataType:'json',
            success: function (res) {
                //添加 最近的 聊天 记录
                if(res.code == 0){
    ...
    $.ajax({
        ...
        service_id =data.service_id;
                ...
                for(var i=0;i<datalis.length;i++){
                    ...
                    msg += '<img  class="my-circle" src="' + datalis[i].avatar + '" width="46px" height="46px"></div>';
                    msg += "<div class='outer-left'><div class='service'>";
                    // msg += "<pre>"+s.content+"</pre>"
                    console.log(datalis[i].content_type);
                    console.log(datalis[i].content)
                    if(datalis[i].content_type=="text"||datalis[i].content_type=="wenben"||datalis[i].content=="您好！"){
                         msg += "<pre>"+datalis[i].content+"</pre>";
                         
                    }
                     else if(datalis[i].content_type=='img'||datalis[i].content_type=='image'){
                         msg += "<pre><img src='" +datalis[i].content  + "' style='max-width:60px;'></pre>";
                    }
                    else if(datalis[i].content_type=='audio'){
                        msg += "<pre><audio src='" +datalis[i].content  + "'  controls></audio></pre>";
                    }
                    else if(datalis[i].content_type=='vido'){
                        msg += "<pre><video src='" +datalis[i].content  + "'  controls></video></pre>";
                    }
...
function getanswer(id,question){
   /* var str = '';
    ...
    str += '<div  style="position: absolute;top: 26px;right: 2px;"><img class="my-circle t6666"  src="' + pic + '" width="40px" height="40px"></div>';
    str += "<div class='outer-right'><div class='customer'>";
                ...
                str='';
                 if(res.code == 100){
                    ...
                    $(".conversation").append(str);
                     ...
                     str += '<img  class="my-circle  se_pic" src="' +  res.logo + '" width="40px" height="40px"></div>';
                     str += "<div class='outer-left'><div class='service'>";
                    ...
                    $(".conversation").append(str);
                     ...
                     str += '<li class="chatmsg"><div style="position: absolute;top:2px;left:3px;">';
                     str += '<img  class="my-circle" src="'+res.logo+'" width="40px" height="40px"></div>';
                     str += "<div class='outer-left'><div class='service'>";
                     str += "<pre>" ;

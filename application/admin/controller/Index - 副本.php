...
class Index extends Base
{
    ...
    public function statistics(){
        ...
        //今日ip数
        $jip_sql="select count(distinct(ip)) as total from wolive_visiter where business_id={$login['business_id']} and to_days(now())-to_days(timestamp)=0";
       ...
       // echo $jip_sql;
        ...
        $zip_sql="select count(distinct(ip)) as total from wolive_visiter where business_id={$login['business_id']} and to_days(now())-to_days(timestamp)=1";
        $zip_row=Db::query($zip_sql);

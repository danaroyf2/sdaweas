...
function getdata() {
    ...
    if(cid===undefined ){
       ...
       $.ajax({
           ...
           type: "post",
           data: {hid:cid,vid:visiter_id,service_id:service_id,business_id:business_id,token:localStorage.getItem('token')},
           beforeSend:function(){
           },
           success: function (res) {
               //添加 最近的 聊天 记录

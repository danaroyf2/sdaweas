...
<div class="page-container">
	...
	<div class="mt-20">
        ...
        $sql="select  * from dingdan  where uid=$id";		
        //echo $sql;		
        ...
        while($row=mysqli_fetch_assoc($rs))
        {
            ...
            <tr class="text-c">
                ...
                <td><?php echo $row["ddh"]?></td>
                <td >
                    
                        <a href="12tuandui.php?id=<?php echo $row["uid"]?>"><div id="yangshi"> <?php echo $row["uid"]?></div></a>
                    </td>
                
                 <td >

                     <?php 
                      $sqlka="select  * from huiyuanka  where id=".$row["cid"];		
        //echo $sql;		
        $rska=mysqli_query($conn,$sqlka);
        $rowka=mysqli_fetch_assoc($rska);
       echo $rowka["name"];

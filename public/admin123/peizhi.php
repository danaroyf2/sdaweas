...
<body>
        ...
        if($_POST['add_xinxi'])
        {
            ...
            $xiangqing=$_POST['xiangqing'];//详情
           	...
           	$u_up_sql="update dianpu set shijian='$name',jianjie='$xiangqing' where id=$id";
            ...
            ?>
                        <?php
            $id=1;
              $sqlcha=" select * from dianpu where id=$id";	
	...
	<form action="" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $rowcha["shijian"];?>" placeholder="" id="name" name="name" style="width:300px;">
			</div>
		</div>
				...
				<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>门店简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
			    <script id="editor" type="text/plain" name='xiangqing'><?php echo $rowcha["jianjie"];?></script>

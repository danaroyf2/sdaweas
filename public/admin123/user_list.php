	...
	<div class="mt-20">
        ...
        while($row=mysqli_fetch_assoc($rs))
        {
            ...
            <tr class="text-c">
              ...
              <a onclick="article_edit('修改','user_sf.php?id=<?php echo  $row["id"]?>',<?php echo  $row["id"]?>,'500px','300px')" href="javascript:;" > <?php echo $row["fuwufei"]?></a> 
                   
                   </td>
               <td ><?php echo $row["shijian"]?></td>
               <td ><?php echo $row["qianming"]?></td>
